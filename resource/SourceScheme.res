...
Scheme
{
	...
	Colors
	{
	    "TFDarkBrown"               "55 55 55 255"
	    "TFDarkBrownTransparent"    "55 55 55 190"
	    "TFTanBright"               "220 220 220 150"
	    "TFTanLight"                "180 180 180 150"
	    "TFTanMedium"               "125 125 125 150"
	    
	    "TFTanLightBright"          "220 220 220 90"
	    "TFTanLightDark"            "85 85 85 90"
	    
	    "TFOrangeBright"            "150 50 50 255"
	    
	    "TFTextBright"              "230 230 230 150"
	    "TFTextLight"               "200 200 200 255"
	    "TFTextMedium"              "120 120 120 255"
	    "TFTextMediumDark"          "100 100 100 255"
	    "TFTextBlack"               "0 0 0  255"
	    "TFTextDull"                "110 110 110 255"

	    "TFMediumBrown"				"65 65 65 255"

	    "QuickListBGDeselected"		"60 60 60 255"
	    "QuickListBGSelected"       "120 120 120 150"
	    
	    "Blank"						"0 0 0 0"
	    
	    // background colors
		"ControlBG"			"75 75 75 255"		// background color of controls
		"ControlDarkBG"		"90 90 90 255"		// darker background color; used for background of scrollbars
		"WindowBG"			"65 65 65 255"		// background color of text edit panes (chat, text entries, etc.)
		"SelectionBG"		"150 50 50 255"		// background color of any selected text or menu item
		"SelectionBG2"		"63 63 63 255"		// selection background in window w/o focus
